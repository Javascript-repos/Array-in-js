const matrix = require("../src/task20");
const chai = require("chai");
const expect = chai.expect;

describe("Spiral matrix #start_test", () => {
  it("create a spiral matrix", () => {
    let output = matrix(2);
    expect(output).to.deep.equal([[1, 2], [4, 3]]);
  });
  it("create a spiral matrix", () => {
    let output = matrix(3);
    expect(output).to.deep.equal([[1, 2, 3], [8, 9, 4], [7, 6, 5]]);
  });
  it("create a spiral matrix", () => {
    let output = matrix(4);
  ...
  it("create a spiral matrix #end_test", () => {
    let output = matrix(13);
    expect(output).to.deep.equal([
